...
! function(t, e) {
    ...
    class $ {
        ...
        _mergeConfigObj(t, e) {
            ...
            return {...this.constructor.Default, ...
                "object" == typeof i ? i : {}, ...n(e) ? H.getDataAttributes(e) : {}, ...
                "object" == typeof t ? t : {}
            }
        }
    ...
    class Ui extends $ {
        ...
        changeContent(t) {
            return this._checkContent(t), this._config.content = {...this._config.content, ...t
            }, this
        }
        toHtml() {
            const t = document.createElement("div");
    ...
    class ln extends W {
        ...
        _getTemplateFactory(t) {
            return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new Ui({...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass)
    ...
    class _n extends W {
        ...
        _configAfterMerge(t) {
            return t.target = s(t.target) || document.body, t.rootMargin = t.offset ? `${t.offset}px 0px -50%` : t.rootMargin, "string" == typeof t.threshold && (t.threshold = t.threshold.split(",").map((t => Number.parseFloat(t)))), t
        }
